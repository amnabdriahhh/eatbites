...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2026 at 04:23 PM
...
INSERT INTO `orders` (`id`, `customer_name`, `phone`, `table_no`, `total_price`, `order_status`, `order_time`) VALUES
(2, 'zulaika', '01162079120', '12', 17.50, 'preparing', '2026-01-19 23:19:42');
...
INSERT INTO `order_items` (`id`, `order_id`, `menu_id`, `menu_name`, `price`, `quantity`, `subtotal`) VALUES
(3, 2, 5, 'Iced Lemon Tea', 3.00, 1, 3.00),
(4, 2, 2, 'Nasi Lemak', 8.00, 1, 8.00),
(5, 2, 3, 'Chocolate Cake', 6.50, 1, 6.50);
